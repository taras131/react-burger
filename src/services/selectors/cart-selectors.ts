...
export const getCart = (state: RootState): IIngredientInCartTypes[]  => {
...
export const getBunInCart = (state: RootState): IIngredientInCartTypes | null => {
    try {
...
export const getNotBunIngredients = (state: RootState): IIngredientInCartTypes[] | null => {
    try {
